...
export default async function Home({
  ...
  return (
    <div className="space-y-8">
      {/* Topic Banner */}
      {topic && (
        <div className="bg-gradient-to-r from-purple-600 to-purple-800 dark:from-purple-800 dark:to-purple-900 text-white">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-purple-200 text-sm">
                    Filtered articles and news
                  </p>
                </div>
              </div>
              <Link
                href="/"
                className="inline-flex items-center px-4 py-2 bg-white/20 hover:bg-white/30 text-white font-medium rounded-lg transition-colors duration-200"
              >
                <svg
