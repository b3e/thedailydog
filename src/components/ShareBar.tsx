      ...
      >
        {copied ? (
          ...
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16h8a2 2 0 002-2V7a2 2 0 00-2-2h-5m-3 11H7a2 2 0 01-2-2V7a2 2 0 012-2h5m0 0L8 8m4-3l-4 3" />
          </svg>
        )}
      </button>
    </div>
