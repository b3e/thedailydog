        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <img
                src="/logo-slogan.png"
                alt="Daily Dog Logo"
                className="h-18 object-contain group-hover:scale-105 transition-transform duration-200 dark:hidden"
              />
              <img
                src="/logo-slogan-dark.png"
                alt="Daily Dog Logo"
                className="h-18 object-contain group-hover:scale-105 transition-transform duration-200 hidden dark:block"
              />
            </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors duration-200 cursor-pointer"
